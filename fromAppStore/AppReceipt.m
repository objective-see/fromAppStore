...
-(instancetype)init:(NSString *)appPath
{
    //app bundle
    NSBundle* bundle = nil;
    ...
    if(self = [super init])
    {
        ...
        {
            //err msg
            NSLog(@"ERROR: failed to load app bundle");
        ...
        {
            //err msg
            NSLog(@"ERROR: could not find app store receipt url, or file (%@)", bundle.appStoreReceiptURL.path);
        ...
        //dbg msg
        NSLog(@"found receipt at: %@", bundle.appStoreReceiptURL.path);
        ...
        {
            //err msg
            NSLog(@"ERROR: could not load receipt's encoded data");
        ...
        {
            //err msg
            NSLog(@"ERROR: could not decode receipt's data");
        ...
        {
            //err msg
            NSLog(@"ERROR: could not parse receipt's decoded data");
